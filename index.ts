...
export const ContractLeft = 'contract-left';
...
export const ExpandRight = 'expand-right';
...
export const LeadList = 'lead-list';
...
export const OpportunityList = 'opportunity-list';
...
export const PinO = 'pin-o';
export const PlacementList = 'placement-list';
...
export const ShieldInfo = 'shield-info';
export const ShieldLine = 'shield-line';
export const ShieldWarning = 'shield-warning';
...
export const SubmissionList = 'submission-list';
